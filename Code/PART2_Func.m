function [cMap,Vmap,Ex,Ey,Jx,Jy,Current, Box_top_rec, Box_bottom_rec] = PART2_Func(RatioVal,LWInc,BL_per, BW_per, BN_nar, condIn)
L = RatioVal*3+LWInc; %Length of Region
W = RatioVal*2+LWInc; %Width of Region
